...
#     first_name: 'くま',
#     last_name: 'しょう',
#     first_name_reading:'くま',
#     last_name_reading: 'しょう',
#     post_code: '1234567',
#     prefecture_id: '1',
#     address_city: '名古屋市',
#     address_street: '栄',
#     address_building: '栄ビル111',
...
Order.create!(
  [{
    order_day: '2020/04/14',
    user_id: 1,
    item_id: 1,
    deliver_address_id: 1
  }]
)

# ItemImage.create!(
#   [{
#   image_url: File.open('./app/assets/images/image.jpeg'),
#   item_id: 1
#   }]
# )

  # choice = Category.create(name: "カテゴリー")
  # # レディース
